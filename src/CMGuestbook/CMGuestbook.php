...
class CMGuestbook extends CObject implements IHasSQL {
  ...
  public function Init() {
    try {
      ...
      $this->session->AddMessage('notice', 'Skapade ny databastabell.');
    } catch(Exception$e) {
  ...
  public function Add($entry) {
    ...
    $this->session->AddMessage('success', 'Lade till ett nytt meddelande..');
  ...
  public function DeleteAll() {
    ...
    $this->session->AddMessage('info', 'Tog bort alla meddelanden.');
  }
